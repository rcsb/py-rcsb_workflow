...
class ResidueRsccReferenceGeneratorTests(unittest.TestCase):
    ...
    def testFetchEntry(self):
        ...
        self.cRRRG.fetchEntry(resolution_bin=resolution_bin)
