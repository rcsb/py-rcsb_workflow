...
RUN pip install --no-cache-dir git+https://github.com/rcsb/py-rcsb_utils_repository.git@dev-dwp-ihm
RUN pip install --no-cache-dir git+https://github.com/rcsb/py-rcsb_utils_dictionary.git@pdb-ihm-2
RUN pip install --no-cache-dir git+https://github.com/rcsb/py-rcsb_db.git@dev-dwp-ihm
