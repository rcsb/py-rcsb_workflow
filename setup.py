...
setup(
    ...
    entry_points={"console_scripts": ["exdb_wf_cli=rcsb.workflow.cli.ExDbExec:main", "imgs_exec_cli=rcsb.workflow.cli.ImgExec:main", "bcif_exec_cli=rcsb.workflow.cli.BcifExec:main", "chem_search_index_cli=rcsb.workflow.cli.ChemSearchIndexExec:main"]},
